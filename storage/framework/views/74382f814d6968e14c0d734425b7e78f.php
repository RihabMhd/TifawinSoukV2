                                ...
                                <div class="border-t border-gray-200 dark:border-gray-700 pt-6 mt-6">
                                    <dl class="grid grid-cols-1 gap-4">
                                        <div>
                                            ...
                                            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100"><?php echo e($product->user->name); ?></dd>
                                        </div>
                                        <div>
                                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Listed on</dt>
                                            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100"><?php echo e($product->created_at->format('F j, Y')); ?></dd>
                                        </div>
                                    </dl>
                                </div>
                            </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\TifawinSouk\resources\views/products/show.blade.php ENDPATH**/ ?>