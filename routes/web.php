...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/stock/adjust/{id}', [StockController::class, 'edit'])->name('admin.stock.edit');
    Route::patch('/stock/adjust/{product}', [StockController::class, 'adjust'])->name('admin.stock.adjust');
});
