    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="text-right">
                ...
                <p class="text-sm text-gray-800 dark:text-gray-200 font-medium">{{ now()->format('M d, Y - H:i') }}</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <h3 class="text-3xl font-bold text-white">${{ number_format($product_valeur_inventaire, 2) }}</h3>
                            </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <h3 class="text-3xl font-bold text-white">{{ count($product_rupture) }}</h3>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <h3 class="text-3xl font-bold text-white">{{ count($product_stock_critique) }}</h3>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <!-- Table Section -->
                @if(count($product_rupture) > 0 || count($product_stock_critique) > 0)
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody id="productTable" class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr data-status="rupture" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm text-gray-700 dark:text-gray-300">{{ $product->stock_alert_threshold }}</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <span class="text-2xl font-bold text-red-600 dark:text-red-400">{{ $product->quantity }}</span>
                            ...
                            <tr data-status="critical" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <span class="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{{ $product->quantity }}</span>
                                        <span class="ml-2 text-xs text-gray-500 dark:text-gray-400">units</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
