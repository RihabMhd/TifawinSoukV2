                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                        ...
                        <textarea name="order_notes" 
                                  ...
                                  class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('order_notes') }}</textarea>
                    </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6 sticky top-24">
                        ...
                        <div class="space-y-2 mb-4">
                            ...
                            <div class="flex justify-between text-sm text-gray-700 dark:text-gray-300">
                                <span>TVA (20%)</span>
                                <span>${{ number_format($cart->getTotal() * 0.20, 2) }}</span>
                            </div>
                        </div>
