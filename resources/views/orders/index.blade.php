                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select name="sort_by" id="sort_by"
                                    ...
                                    <option value="created_at"
                                        {{ request('sort_by') === 'created_at' ? 'selected' : '' }}>Date</option>
                                    <option value="total" {{ request('sort_by') === 'total' ? 'selected' : '' }}>
                                        Montant</option>
                                    <option value="order_number"
                                        {{ request('sort_by') === 'order_number' ? 'selected' : '' }}>Numéro</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="price_min" id="price_min"
                                    value="{{ request('price_min') }}" step="0.01" placeholder="0.00"
                                    class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="price_max" id="price_max"
                                    value="{{ request('price_max') }}" step="0.01" placeholder="0.00"
                                    class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
                        </div>
                        ...
                        <div class="mt-4 pt-4 border-t dark:border-gray-700">
                            <div class="flex items-center gap-2 flex-wrap">
                                ...
                                @foreach ($activeFilters as $filter)
                                    <span
                                        class="inline-flex items-center gap-1 px-3 py-1 rounded-full text-sm bg-blue-100 dark:bg-blue-900/20 text-blue-800 dark:text-blue-200">
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-500 dark:text-gray-400">
                                                ...
                                                article{{ $order->products->count() > 1 ? 's' : '' }}
                                            </div>
                                        </td>
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl transform transition-all duration-300 scale-95 opacity-0"
                ...
                <div class="relative bg-gradient-to-r from-red-600 to-red-500 rounded-t-xl px-6 py-6">
                    <div class="flex items-center justify-center">
                        <div
                            class="inline-flex items-center justify-center w-16 h-16 bg-white bg-opacity-20 rounded-full backdrop-blur-sm">
                ...
                <div class="px-6 py-6">
                    <div class="text-center space-y-3">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Cette action est <span
                                class="font-semibold text-red-600 dark:text-red-400">irréversible</span>
                            et ne pourra pas être annulée.
                        </p>
                    </div>

                    <div
                        class="mt-5 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                        <div class="flex items-start">
                            ...
                            <div class="text-sm text-red-800 dark:text-red-300">
                                ...
                                <p class="mt-1 text-red-700 dark:text-red-400">La commande sera définitivement annulée
                                    et les produits seront remis en stock.</p>
                            </div>
                        </div>
                    </div>
